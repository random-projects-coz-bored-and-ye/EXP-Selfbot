...
- **Custom Presence**: Automatically sets a custom "Playing" or "Custom Activity" status upon login.
- **Terminal Feedback**: Provides clear console logs whenever a message is successfully sent.

## Prerequisites
- [Python 3.8+](https://www.python.org)
- Your Discord User Token (get from applications -> local storage (js google a tutorial))
